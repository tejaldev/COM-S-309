...
class Main {
    ...
    CommandLineRunner initUser(UserRepository userRepository, LaptopRepository laptopRepository) {
        return args -> {
            ...
            Laptop laptop1 = new Laptop( "raghu", "raghu", "raghu", "raghu", "raghu");
            Laptop laptop2 = new Laptop( "varun", "varun", "varun", "varun", "varun");
            Laptop laptop3 = new Laptop( "vivek", "vivek", "vivek", "vivek", "vivek");
